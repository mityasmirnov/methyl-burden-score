...
| `N-cascade-vector-mean-max` | 5 | — | 5,5,4 (μ=4.7) | 3 |
| `N-cascade-vector-max-max` | 5 | — | 5,4,5 (μ=4.7) | 3 |
...
| N-cascade-vector-max-max | 0.343 (±0.063) | 0.367 | — | 21.458 | 0.687 | 5,4,5 (μ=4.7) | — | 3 |
